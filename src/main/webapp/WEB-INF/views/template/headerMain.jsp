	...
	<div id="mallmenu" class="menu-wrap-row">
		<div id="mainmenu2">
			...
			<sec:authorize access="isAuthenticated()">
				<span class="loginInfo"><sec:authentication property="principal.member.user_id"/>님, 환영합니다.</span>
			...
			<a class="categoryfontcolor" id="searchcategoryhover"
			...
			<div class="form-group">
				<div class="col-xs-6 col-xs-offset-1">
					<input type="hidden" name="searchType" value="title"> <input
						type="text" class="searchtextinput" name="searchData"
